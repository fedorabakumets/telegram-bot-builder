...
// 9. Исправляем проблемы с command свойством
...
// 10. Добавляем недостающие свойства в интерфейсы
...
// 11. Исправляем проблемы с successMessage
...
// 12. Исправляем проблемы с buttonType в узлах
...
// 13. Исправляем проблемы с ResponseOption id
...
// 14. Исправляем неиспользуемые переменные - добавляем комментарии
const unusedVarPatterns = [
    { pattern: /const hasButtons = [^;]+;/g, replacement: '// const hasButtons - используется для проверки наличия кнопок' },
    { pattern: /const inputType = [^;]+;/g, replacement: '// const inputType - тип ввода для обработки' },
    { pattern: /const inputVariable = [^;]+;/g, replacement: '// const inputVariable - переменная для сохранения ввода' },
    { pattern: /const inputTargetNodeId = [^;]+;/g, replacement: '// const inputTargetNodeId - ID целевого узла' },
    { pattern: /const parseMode = [^;]+;/g, replacement: '// const parseMode - режим парсинга текста' },
    { pattern: /const totalButtons = [^;]+;/g, replacement: '// const totalButtons - общее количество кнопок' }
];
