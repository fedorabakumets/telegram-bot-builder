/**
 * @fileoverview Утилита для форматирования и обработки текста
 * 
 * Этот модуль предоставляет функции для безопасного преобразования
 * идентификаторов узлов в корректные имена функций Python.
 * 
 * @module createSafeFunctionName
 */
