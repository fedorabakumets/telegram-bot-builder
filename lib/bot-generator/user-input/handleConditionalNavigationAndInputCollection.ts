                    ...
                    if (hasConditionalMessages) {
                        ...
                        for (let i = 0; i < conditionalMessages.length; i++) {
                            ...
                            if (condition.condition === 'user_data_exists' && variableNames.length > 0) {
                                ...
                                code += `                            # Получаем фильтры переменных для замены\n`;
                                code += `                            variable_filters = user_data.get(user_id, {}).get("_variable_filters", {})\n`;
                                code += `                            text = replace_variables_in_text(text, user_data_dict, variable_filters)\n`;
                                ...
                                if (shouldWaitForInput) {
                                    ...
                                    if (hasConditionalButtons) {
                                        ...
                                        code += `                                # Получаем фильтры переменных для замены\n`;
                                        code += `                                variable_filters = user_data.get(user_id, {}).get("_variable_filters", {})\n`;
                                        code += `                                main_text = replace_variables_in_text(main_text, user_data_dict, variable_filters)\n`;
