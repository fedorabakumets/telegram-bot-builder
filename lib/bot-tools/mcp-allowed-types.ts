...
const MCP_NODE_DESCRIPTIONS: Record<string, string> = {
  ...
  member_trigger: 'Триггер на вход или выход участника из группы',
  create_forum_topic: 'Создание топика форума',
  kick_user: 'Исключение пользователя из чата',
  ban_user: 'Блокировка пользователя в группе',
  unban_user: 'Разблокировка пользователя',
  mute_user: 'Запрет писать в группе',
  unmute_user: 'Снятие запрета писать',
  promote_user: 'Назначение администратором',
  demote_user: 'Снятие прав администратора',
  admin_rights: 'Изменение прав администратора',
