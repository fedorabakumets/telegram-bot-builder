...
export function nodeToUserInputParams(node: Node): UserInputTemplateParams {
  ...
  return {
    ...
    retryMessage: nodeData.retryMessage || nodeData.inputRetryMessage || 'Пожалуйста, попробуйте еще раз.',
    successMessage: nodeData.successMessage || nodeData.inputSuccessMessage || '',
    inputTimeout: typeof nodeData.inputTimeout === 'number' ? nodeData.inputTimeout : 0,
    inputTimeoutMessage: nodeData.inputTimeoutMessage || 'Время ожидания истекло.',
