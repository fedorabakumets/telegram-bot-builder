...
// Регулярное выражение для поиска импортов с '@/lib/' - теперь захватываем весь путь
...
if (hasLibImports) {
  ...
  while ((match = importRegex.exec(content)) !== null) {
    ...
    const toPart = '"';  // всегда кавычка, так как она входит в importPath
    ...
    const newImport = fromPart + relativePath + '"';
