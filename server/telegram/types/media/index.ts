/**
 * @fileoverview Баррер-файл для экспорта всех типов медиа
 * @module server/telegram/types/media/index
 * @description Экспортирует типы для работы с медиафайлами Telegram
 */
