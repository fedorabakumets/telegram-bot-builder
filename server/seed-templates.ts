...
async function seedDefaultTemplates(force = false) {
  try {
    ...
    await storage.createBotTemplate({
      ...
      description: "Продвинутая анкета для знакомств: возраст, пол, интересы, город, имя, описание и фото. Включает полный цикл с просмотром анкет!",
      category: "community",
      ...
      complexity: 3,
      estimatedTime: 10,
      data: JSON.parse('{"sheets": [{"id": "q_8sYZc9BzWhPbkt1DiaL", "name": "Основной поток", "nodes": [{"_y": 100, "id": "start", "data": {"buttons": [], "command": "/start", "markdown": false, "adminOnly": false, "showInMenu": true, "description": "Запустить бота", "messageText": "Сколько тебе лет?", "keyboardType": "none", "requiresAuth": false, "inputVariable": "age", "isPrivateOnly": false, "resizeKeyboard": true, "enableTextInput": true, "oneTimeKeyboard": false, "collectUserInput": true, "enableStatistics": true, "inputTargetNodeId": "f90r9k3FSLu2Tjn74cBn_", "conditionalMessages": [{"id": "condition-1763692642023", "buttons": [{"id": "b5XNyuzu_-YIFk3yfUfpj", "url": "", "text": "{age}", "action": "goto", "target": "f90r9k3FSLu2Tjn74cBn_", "buttonType": "normal", "skipDataCollection": false}], "priority": 10, "condition": "user_data_exists", "formatMode": "text", "messageText": "Привет снова! Тебе уже {age} лет, правильно?", "keyboardType": "reply", "variableName": "age", "logicOperator": "AND", "variableNames": ["age"], "waitForTextInput": true, "nextNodeAfterInput": "f90r9k3FSLu2Tjn74cBn_"}], "enableConditionalMessages": true}, "type": "start", "position": {"x": 100, "y": 100}}, {"_y": 643.75, "id": "f90r9k3FSLu2Tjn74cBn_", "data": {"buttons": [{"id": "iIkbMb2jlZRJOxGHMNl1a", "text": "Я девушка", "action": "goto", "target": "RFTgm4KzC6dI39AMTPcmo", "buttonType": "normal", "skipDataCollection": false}, {"id": "0dBjAkcTa9rEsjEP48XzB", "text": "Я парень", "action": "goto", "target": "RFTgm4KzC6dI39AMTPcmo", "buttonType": "normal", "skipDataCollection": false}], "markdown": false, "adminOnly": false, "showInMenu": true, "messageText": "Теперь определимся с полом", "keyboardType": "reply", "requiresAuth": false, "isPrivateOnly": false, "resizeKeyboard": true, "oneTimeKeyboard": false, "enableStatistics": true}, "type": "message", "position": {"x": 100, "y": 643.75}}, {"_y": 1076.5, "id": "RFTgm4KzC6dI39AMTPcmo", "data": {"buttons": [{"id": "6bA3YPgWd20pCqPAeyuLe", "text": "Девушки", "action": "goto", "target": "sIh3xXKEtb_TtrhHqZQzX", "buttonType": "normal", "skipDataCollection": false}, {"id": "hI7nsCdodrcUnft1SXYpg", "text": "Парни", "action": "goto", "target": "sIh3xXKEtb_TtrhHqZQzX", "buttonType": "normal", "skipDataCollection": false}, {"id": "VhOGaPeyFpFV9a7QDBfzo", "text": "Все равно", "action": "goto", "target": "sIh3xXKEtb_TtrhHqZQzX", "buttonType": "normal", "skipDataCollection": false}], "markdown": false, "adminOnly": false, "showInMenu": true, "messageText": "Кто тебе интересен?", "keyboardType": "reply", "requiresAuth": false, "isPrivateOnly": false, "resizeKeyboard": true, "oneTimeKeyboard": false, "enableStatistics": true}, "type": "message", "position": {"x": 100, "y": 1076.5}}, {"_y": 1509.25, "id": "sIh3xXKEtb_TtrhHqZQzX", "data": {"buttons": [], "markdown": false, "adminOnly": false, "showInMenu": true, "messageText": "Из какого ты города?", "keyboardType": "none", "requiresAuth": false, "inputVariable": "city", "isPrivateOnly": false, "resizeKeyboard": true, "enableTextInput": true, "oneTimeKeyboard": false, "collectUserInput": true, "enableStatistics": true, "inputTargetNodeId": "tS2XGL2Mn4LkE63SnxhPy", "conditionalMessages": [{"id": "cond-city-1", "priority": 10, "condition": "user_data_exists", "variableName": "city", "variableNames": ["city"], "logicOperator": "AND", "messageText": "Ты из города {city}, верно?", "formatMode": "text", "keyboardType": "reply", "waitForTextInput": true, "nextNodeAfterInput": "tS2XGL2Mn4LkE63SnxhPy", "buttons": [{"id": "btn-city-yes", "text": "Да, верно", "action": "goto", "target": "tS2XGL2Mn4LkE63SnxhPy", "buttonType": "normal", "skipDataCollection": false}]}], "enableConditionalMessages": true}, "type": "message", "position": {"x": 100, "y": 1509.25}}, {"_y": 1942, "id": "tS2XGL2Mn4LkE63SnxhPy", "data": {"buttons": [], "markdown": false, "adminOnly": false, "showInMenu": true, "messageText": "Как мне тебя называть?", "keyboardType": "none", "requiresAuth": false, "inputVariable": "name", "isPrivateOnly": false, "resizeKeyboard": true, "enableTextInput": true, "oneTimeKeyboard": false, "collectUserInput": true, "enableStatistics": true, "inputTargetNodeId": "lBPy3gcGVLla0NGdSYb35", "conditionalMessages": [{"id": "cond-name-1", "priority": 10, "condition": "user_data_exists", "variableName": "name", "variableNames": ["name"], "logicOperator": "AND", "messageText": "Привет, {name}! Рад тебя снова видеть!", "formatMode": "text", "keyboardType": "none", "waitForTextInput": false, "nextNodeAfterInput": "lBPy3gcGVLla0NGdSYb35", "buttons": []}], "enableConditionalMessages": true}, "type": "message", "position": {"x": 100, "y": 1942}}, {"_y": 2374.75, "id": "lBPy3gcGVLla0NGdSYb35", "data": {"buttons": [{"id": "g9KWWguVciHEUMMeyZ-WN", "text": "Пропустить", "action": "goto", "target": "Y9zLRp1BLpVhm-HcsNkJV", "buttonType": "normal", "skipDataCollection": true}], "markdown": false, "adminOnly": false, "showInMenu": true, "messageText": "Расскажи о себе и кого хочешь найти, чем предлагаешь заняться. Это поможет лучше подобрать тебе компанию.", "keyboardType": "reply", "requiresAuth": false, "inputVariable": "info", "isPrivateOnly": false, "resizeKeyboard": true, "enableTextInput": true, "oneTimeKeyboard": false, "collectUserInput": true, "enableStatistics": true, "inputTargetNodeId": "Y9zLRp1BLpVhm-HcsNkJV", "conditionalMessages": [{"id": "cond-info-1", "priority": 10, "condition": "user_data_exists", "variableName": "info", "variableNames": ["info"], "logicOperator": "AND", "messageText": "Вот что ты говорил о себе:\\n{info}\\n\\nХочешь изменить?", "formatMode": "text", "keyboardType": "reply", "waitForTextInput": true, "nextNodeAfterInput": "Y9zLRp1BLpVhm-HcsNkJV", "buttons": [{"id": "btn-info-skip", "text": "Оставить как есть", "action": "goto", "target": "Y9zLRp1BLpVhm-HcsNkJV", "buttonType": "normal", "skipDataCollection": true}]}], "enableConditionalMessages": true}, "type": "message", "position": {"x": 100, "y": 2374.75}}, {"_y": 2807.5, "id": "Y9zLRp1BLpVhm-HcsNkJV", "data": {"buttons": [], "markdown": false, "adminOnly": false, "showInMenu": true, "messageText": "Теперь пришли фото или запиши видео 👍 (до 15 сек), его будут видеть другие пользователи", "keyboardType": "none", "requiresAuth": false, "isPrivateOnly": false, "resizeKeyboard": true, "oneTimeKeyboard": false, "collectUserInput": true, "enablePhotoInput": true, "enableStatistics": true, "photoInputVariable": "photo", "inputTargetNodeId": "8xSJaWAJNz7Hz_54mjFTF", "conditionalMessages": [{"id": "cond-photo-1", "priority": 10, "condition": "user_data_exists", "variableName": "photo", "variableNames": ["photo"], "logicOperator": "AND", "messageText": "У тебя уже есть фото! Хочешь изменить?", "formatMode": "text", "keyboardType": "reply", "waitForTextInput": false, "buttons": [{"id": "btn-photo-keep", "text": "Оставить фото", "action": "goto", "target": "8xSJaWAJNz7Hz_54mjFTF", "buttonType": "normal", "skipDataCollection": true}, {"id": "btn-photo-change", "text": "Загрузить новое", "action": "goto", "target": "", "buttonType": "normal", "skipDataCollection": false}]}], "enableConditionalMessages": true}, "type": "message", "position": {"x": 100, "y": 2807.5}}, {"_y": 3240.25, "id": "8xSJaWAJNz7Hz_54mjFTF", "data": {"buttons": [], "markdown": false, "adminOnly": false, "showInMenu": true, "messageText": "Так выглядит твоя анкета:\\n{name}, {age}, {city} - {info}\\n", "keyboardType": "none", "requiresAuth": false, "attachedMedia": ["photo"], "isPrivateOnly": false, "resizeKeyboard": true, "oneTimeKeyboard": false, "enableStatistics": true}, "type": "message", "position": {"x": 100, "y": 3240.25}}, {"_y": 3673, "id": "KE-8sR9elPEefApjXtBxC", "data": {"buttons": [{"id": "Y6DFar0NH2ejdlKLTFgwC", "text": "Да", "action": "goto", "target": "yrsc8v81qQa5oQx538Dzn", "buttonType": "normal", "skipDataCollection": false}, {"id": "e1ZTOjUMpLqjln0LWH3JD", "text": "Изменить анкету", "action": "goto", "target": "start", "buttonType": "normal", "skipDataCollection": false}], "markdown": false, "adminOnly": false, "showInMenu": true, "messageText": "Все верно?", "keyboardType": "reply", "requiresAuth": false, "isPrivateOnly": false, "resizeKeyboard": true, "oneTimeKeyboard": false, "enableStatistics": true}, "type": "message", "position": {"x": 100, "y": 3673}}, {"_y": 4105.75, "id": "yrsc8v81qQa5oQx538Dzn", "data": {"buttons": [{"id": "kfzexViyPfMpgOffuWXY3", "text": "1", "action": "goto", "target": "", "buttonType": "normal", "skipDataCollection": false}, {"id": "YqVio9545knVkcQWVLbgT", "text": "2", "action": "goto", "target": "start", "buttonType": "normal", "skipDataCollection": false}, {"id": "vMzKMEg84JLzu6EEnrQ5W", "text": "3", "action": "goto", "target": "Y9zLRp1BLpVhm-HcsNkJV", "buttonType": "normal", "skipDataCollection": false}, {"id": "En0QBjOLWkcEpIGLqy6EQ", "text": "4", "action": "goto", "target": "lBPy3gcGVLla0NGdSYb35", "buttonType": "normal", "skipDataCollection": false}], "markdown": false, "adminOnly": false, "showInMenu": true, "messageText": "1. Смотреть анкеты.\\n2. Заполнить анкету заново.\\n3. Изменить фото/видео.\\n4. Изменить текст анкеты.", "keyboardType": "reply", "requiresAuth": false, "isPrivateOnly": false, "resizeKeyboard": true, "oneTimeKeyboard": false, "enableStatistics": true}, "type": "message", "position": {"x": 100, "y": 4105.75}}], "connections": []}], "version": 2, "activeSheetId": "q_8sYZc9BzWhPbkt1DiaL"}')
    });

    console.log('✅ Шаблон Котик v3.0 создан (новейшая версия с условными сообщениями)');
