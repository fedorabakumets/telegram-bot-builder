        ...
        nodes: [
...

          {
            ...
            data: {
              ...
              messageText: "🆘 Справка по боту ᴠᴨᴩᴏᴦʏᴧᴋᴇ\n\n📋 ОСНОВНЫЕ КОМАНДЫ:\n• /start - начать заново (синонимы: старт, начать, привет, начало, начинаем)\n• /profile - показать/редактировать профиль (синонимы: профиль, анкета, мой профиль, посмотреть профиль, редактировать профиль)\n• /link - получить ссылку на чат (синонимы: ссылка, чат, сообщество, впрогулке, линк)\n• /help - эта справка (синонимы: помощь, справка, команды, что писать, как пользоваться)\n\n🎯 РАЗДЕЛЫ АНКЕТЫ И ИХ СИНОНИМЫ:\n• Пол: мужской, женский (синонимы: пол, gender)\n• Имя: любое имя (синонимы: имя, как зовут, назовись)\n• Возраст: число от 18 до 99 (синонимы: возраст, лет, сколько лет)\n• Метро: выбор линии и станции (синонимы: метро, станция)\n  - Красная линия (синонимы: красная линия, кировско-выборгская, красная ветка)\n  - Синяя линия (синонимы: синяя линия, московско-петроградская, синяя ветка)\n  - Зеленая линия (синонимы: зеленая линия, невско-василеостровская, зеленая ветка)\n  - Оранжевая линия (синонимы: оранжевая линия, правобережная, оранжевая ветка)\n  - Фиолетовая линия (синонимы: фиолетовая линия, фрунзенско-приморская, фиолетовая ветка)\n• Интересы и их синонимы:\n  - Хобби (синонимы: хобби, увлечения, занятия, игры)\n  - Социальная жизнь (синонимы: общение, социальное, люди, тусовки)\n  - Творчество (синонимы: творчество, искусство, рисование, музыка)\n  - Активный образ жизни (синонимы: активность, активный, движение, здоровье)\n  - Еда и напитки (синонимы: еда, напитки, кухня, рестораны)\n  - Спорт (синонимы: спорт, фитнес, тренировки, футбол)\n• Семейное положение: поиск, отношения, женат/замужем, сложно (синонимы: семейное положение, статус, отношения, семья)\n• Ориентация: гетеро, гей, лесби, би, другое (синонимы: ориентация, предпочтения)\n• Телеграм-канал: опционально (синонимы: тгк, телеграм, канал, тг канал)\n• О себе: дополнительная информация (синонимы: о себе, описание, расскажи, инфо)\n\n🔄 ДОПОЛНИТЕЛЬНЫЕ ФРАЗЫ:\n• Для присоединения к чату (синонимы: чат, присоединиться, вступить, группа, сообщество)\n• При отказе (синонимы: понятно, хорошо, ладно, ок, передумаю)\n• При завершении профиля (синонимы: готово, завершено, профиль готов, анкета готова)\n\n💡 ПОДСКАЗКИ:\n• Можешь писать команды или синонимы в любом месте разговора\n• Бот поймет твои сообщения даже без команд\n• В любой момент можешь написать /start для начала заново\n• Используй /profile для изменения любых данных",
              keyboardType: "inline",
              buttons: [
                {
                  id: "btn-help-start",
