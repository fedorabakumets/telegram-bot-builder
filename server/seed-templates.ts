...
export async function seedDefaultTemplates(force = false) {
  try {
    ...
    // Обновленный шаблон с множественным выбором интересов
    await storage.createBotTemplate({
      name: "Выбор интересов - улучшенный",
      description: "Функциональный шаблон для сбора интересов с реальными действиями и персонализацией",
      category: "business",
      ...
      data: {
        nodes: [
          ...
          },
          {
            ...
            data: {
              messageText: "👥 Найти единомышленников:\n\nВаши интересы: {интересы}\n\nВыберите действие:",
              keyboardType: "inline",
              buttons: [
                {
                  id: "btn_find_chats",
                ...
                {
                  id: "btn_nearby_people",
                  text: "📍 Люди рядом",
                  action: "goto",
                  target: "nearby_people"
                },
                {
          ...
          },
          {
            ...
            data: {
              ...
              buttons: [
                {
                  id: "btn_quick_recipes",
                  text: "⚡ Быстрые рецепты",
                  action: "goto",
                  target: "quick_recipes"
                },
                {
                  id: "btn_healthy_food",
                  text: "🥗 Здоровое питание",
                  action: "goto",
                  target: "healthy_recipes"
                },
                {
                  id: "btn_desserts",
                  text: "🍰 Десерты",
                  action: "goto",
                  target: "dessert_recipes"
                },
                {
                  id: "btn_chef_tips",
                  text: "👨‍🍳 Советы шеф-повара",
                  action: "goto",
                  target: "chef_tips"
                },
                {
