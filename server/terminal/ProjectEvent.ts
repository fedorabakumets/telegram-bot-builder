...
export interface ProjectEvent {
  /** Тип события: создание/удаление токена, изменение статуса бота, новое/удалённое/отредактированное сообщение диалога, новый пользователь или прогресс рассылки */
  type: 'token-created' | 'token-deleted' | 'bot-started' | 'bot-stopped' | 'bot-error' | 'new-message' | 'message-deleted' | 'message-edited' | 'new-user' | 'broadcast-progress';
  /** Идентификатор проекта */
  projectId: number;
