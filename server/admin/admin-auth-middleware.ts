...
export function requireAdminAuth(req: Request, res: Response, next: NextFunction): void {
  ...
  if (acceptsHtml || req.path === "/admin" || req.path.startsWith("/admin/settings") || req.path.startsWith("/admin/docs") || req.path.startsWith("/admin/schema") || req.path.startsWith("/admin/api-docs")) {
