...
│       │   ├── editor/              # Компоненты редактора (холст, панель свойств, экспорт)
│       │   └── media/               # Компоненты для работы с медиафайлами
│       ├── pages/                   # Страницы приложения (редактор, настройки)
│       ├── lib/                     # Утилиты, хуки и логика (bot-generator.ts, commands.ts)
