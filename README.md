...
На вкладке **"Группы"** вы можете управлять группами, в которых работает ваш бот:

**Основные функции:**
- **Создать группу** - создать новую группу для организации пользователей
- **Добавить участников** - приглашать пользователей в группу
- **Посмотреть членов** - список всех участников группы
- **Настройки группы** - изменить название, описание, права доступа
- **Удалить группу** - удалить группу, если она больше не нужна

**Что можно настроить в группе:**
- 👥 **Управление участниками** - добавлять/удалять людей
