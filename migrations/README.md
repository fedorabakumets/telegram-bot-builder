...
- `0001_add_google_sheet_export_fields.sql` - добавление полей для экспорта в Google Таблицы (пользователи)
- `0002_add_structure_export_fields.sql` - добавление полей для экспорта структуры проекта
