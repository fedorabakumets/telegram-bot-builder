...
async def handle_reply_iIkbMb2jlZRJOxGHMNl1a(message: types.Message):
    ...
    logging.info(f"✅ Состояние ожидания настроено: type='button', modes=['button'] для переменной sex (узел RFTgm4KzC6dI39AMTPcmo)")
                ...
                try:
                    ...
                    while next_node_id:
                        ...
                        if current_node_id == "start":
                            ...
                            logging.info(f"ℹ️ Узел vxPv7G4n0QGyhnv4ucOM5 не собирает ответы (collectUserInput=false)")
