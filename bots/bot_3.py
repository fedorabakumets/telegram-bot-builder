...
async def start_handler(message: types.Message):
    ...
    builder.add(InlineKeyboardButton(text="Новая кнопка", callback_data="es21Wv0L1XsQEeWG6KuEZ"))
...
@dp.callback_query(lambda c: c.data == "es21Wv0L1XsQEeWG6KuEZ")
async def handle_callback_Z47JmR3soclweB4oCVqsi(callback_query: types.CallbackQuery):
    await callback_query.answer()
    text = "Выберите действие:"
    builder = InlineKeyboardBuilder()
    builder.add(InlineKeyboardButton(text="Кнопка 1", callback_data=""))
    builder.add(InlineKeyboardButton(text="Кнопка 2", callback_data=""))
    keyboard = builder.as_markup()
