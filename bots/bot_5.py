...
async def start_handler(message: types.Message):
    ...
    builder.add(InlineKeyboardButton(text="Новая кнопка", callback_data="dwzRDrIeRJUot78UXI_FZ"))
...
@dp.message()
async def message_dwzRDrIeRJUot78UXI_FZ_handler(message: types.Message):
