"""
Тест исправленного форматирования - Telegram Bot
...
async def start_handler(message: types.Message):
    ...
    text = "Привет! <b>Добро пожаловать!</b> Это <i>тест</i> с <u>HTML</u> форматированием."
...
async def handle_callback_test_node(callback_query: types.CallbackQuery):
    ...
    text = "Это <strong>жирный</strong> текст и <em>курсивный</em>"
    builder = InlineKeyboardBuilder()
