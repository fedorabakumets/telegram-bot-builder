...
# └─────────────────────────────────────────┘
    ...
    # 🖼️ Отправляем изображение из attachedMedia
    image_url = "https://example.com/image.jpg"
    logging.info(f"🖼️ Отправка изображения: {image_url}")

    # Подставляем переменные в caption
    caption = replace_variables_in_text(text, all_user_vars)

    # Отправляем изображение с URL
    try:
        ...
        logging.info(f"✅ Изображение отправлено: {image_url}")
    except Exception as e:
