...
async def start_handler(message: types.Message):
    ...
    builder.add(InlineKeyboardButton(text="🔥 Тестовая кнопка", callback_data="XyZ987Test654Random"))
...
@dp.callback_query(lambda c: c.data == "XyZ987Test654Random")
async def handle_callback_XyZ987Test654Random(callback_query: types.CallbackQuery):
    await callback_query.answer()
    text = "✅ Отлично! Inline кнопка работает!"
