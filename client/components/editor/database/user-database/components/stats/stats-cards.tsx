        ...
        {STATS_DATA.map((stat, idx) => (
          ...
          >
            ...
            <div className="text-center">
              <p className="text-base sm:text-xl font-bold text-foreground tabular-nums leading-none">
                {statValues[idx]}
              </p>
              <p className="text-[9px] sm:text-[10px] font-medium text-muted-foreground mt-0.5 sm:mt-1 uppercase tracking-wide">
                {stat.label}
              </p>
            </div>
          </div>
