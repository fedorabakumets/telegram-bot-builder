    ...
    <>
      <div className="space-y-2 xs:space-y-2.5 sm:space-y-3">
        <div className="flex items-center gap-1.5 xs:gap-2 sm:gap-2">
          ...
          <Label className="text-xs xs:text-sm font-semibold truncate">Статистика</Label>
        </div>
        <div className="grid grid-cols-2 xs:grid-cols-3 gap-2 xs:gap-2.5 sm:gap-3 pl-4 xs:pl-5 sm:pl-6">
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-1.5 xs:p-2 sm:p-3 text-center min-w-0">
          ...
          <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-1.5 xs:p-2 sm:p-3 text-center min-w-0">
          ...
          <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-1.5 xs:p-2 sm:p-3 text-center min-w-0 col-span-2 xs:col-span-1">
