    ...
    <>
      <div className="space-y-2 sm:space-y-3">
        ...
        <div className="flex flex-wrap gap-1.5 sm:gap-2 pl-5 sm:pl-6">
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-1.5 sm:p-3 text-center min-w-0 flex-1 sm:flex-none sm:w-[calc(33.333%-0.75rem)]">
            <div className="text-lg sm:text-xl font-bold text-blue-600 dark:text-blue-400 truncate">
              {total}
            </div>
            <div className="text-[10px] sm:text-xs text-muted-foreground whitespace-nowrap">Всего</div>
          </div>
          <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-1.5 sm:p-3 text-center min-w-0 flex-1 sm:flex-none sm:w-[calc(33.333%-0.75rem)]">
            <div className="text-lg sm:text-xl font-bold text-green-600 dark:text-green-400 truncate">
              {userSent}
            </div>
            <div className="text-[10px] sm:text-xs text-muted-foreground whitespace-nowrap">От юзера</div>
          </div>
          <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-1.5 sm:p-3 text-center min-w-0 flex-1 sm:flex-none sm:w-[calc(33.333%-0.75rem)]">
            <div className="text-lg sm:text-xl font-bold text-purple-600 dark:text-purple-400 truncate">
              {botSent}
            </div>
            <div className="text-[10px] sm:text-xs text-muted-foreground whitespace-nowrap">От бота</div>
          </div>
        </div>
        {onOpenDialog && (
          <div className="pl-5 sm:pl-6">
            <Button
              ...
              className="w-full text-xs sm:text-sm min-w-0"
