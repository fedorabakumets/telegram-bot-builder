  ...
  return (
    <div className="relative border border-slate-300/60 dark:border-slate-700/60 rounded-lg bg-white dark:bg-slate-950 overflow-hidden transition-all hover:border-slate-400/80 dark:hover:border-slate-600/80 focus-within:ring-2 focus-within:ring-blue-500/50 dark:focus-within:ring-blue-500/30">
      ...
      <div
        ...
        onInput={onInput}
        onKeyDown={onKeyDown}
        className="min-h-[80px] sm:min-h-[100px] max-h-[200px] overflow-y-auto p-3 sm:p-4 w-full text-sm sm:text-base bg-transparent text-slate-900 dark:text-slate-100 focus:outline-none whitespace-pre-wrap selection:bg-blue-200 dark:selection:bg-blue-900 [&_tg-spoiler]:inline [&_tg-spoiler]:blur-sm [&_tg-spoiler]:bg-slate-300/70 [&_tg-spoiler]:dark:bg-slate-600/70 [&_tg-spoiler]:rounded [&_tg-spoiler]:px-0.5 [&_tg-spoiler]:cursor-pointer [&_tg-spoiler]:transition-[filter] [&_tg-spoiler]:duration-200 hover:[&_tg-spoiler]:blur-none"
        style={{
          lineHeight: '1.5',
