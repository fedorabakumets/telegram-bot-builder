...
export const nodeColors: Record<string, string> = {
  ...
  command: 'bg-gradient-to-br from-indigo-50 to-violet-100 dark:from-indigo-900/30 dark:to-violet-900/30 text-indigo-600 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-800',
  ...
  forward_message: 'bg-gradient-to-br from-amber-100 to-orange-200 dark:from-amber-900/40 dark:to-orange-800/40 text-amber-700 dark:text-amber-300 border-2 border-amber-300 dark:border-amber-700/50 shadow-lg shadow-amber-500/20',
  /** Цвет узла создания топика форум-группы — бирюзовый */
  create_forum_topic: 'bg-gradient-to-br from-teal-100 to-cyan-200 dark:from-teal-900/40 dark:to-cyan-800/40 text-teal-700 dark:text-teal-300 border-2 border-teal-300 dark:border-teal-700/50 shadow-lg shadow-teal-500/20',
  ...
  /** Цвет узла редактирования сообщения — синий (аналогично message) */
  edit_message: 'bg-gradient-to-br from-blue-50 to-sky-100 dark:from-blue-900/30 dark:to-sky-900/30 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800',
  /** Цвет узла установки переменных — изумрудный */
  set_variable: 'bg-gradient-to-br from-emerald-50 to-green-100 dark:from-emerald-900/30 dark:to-green-900/30 text-emerald-600 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800',
  /** Цвет узла прямого SQL-запроса — фиолетовый */
  psql_query: 'bg-gradient-to-br from-violet-50 to-purple-100 dark:from-violet-900/30 dark:to-purple-900/30 text-violet-600 dark:text-violet-400 border border-violet-200 dark:border-violet-800',
  /** Цвет узла конвертации файлов — изумрудный */
  convert_file: 'bg-gradient-to-br from-emerald-50 to-teal-100 dark:from-emerald-900/30 dark:to-teal-900/30 text-emerald-600 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800',
};
