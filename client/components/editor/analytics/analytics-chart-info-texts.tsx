...
export function UsersActivityChartInfo(): React.JSX.Element {
  return (
    <ChartInfoSpoiler>
      ...
      <p>
        «Новички» — впервые появились в этом периоде; остальные — «вернувшиеся».
        Большое число и цифры в легенде — уникальные за весь период.
        Столбцы/линии по дням суммировать нельзя: один человек за три дня
        в графике виден трижды, а в итоге — один раз.
      </p>
    </ChartInfoSpoiler>
  );
}
