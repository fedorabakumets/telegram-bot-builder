...
import { commandTrigger, textTrigger, anyMessageTrigger, groupMessageTrigger, callbackTrigger } from './massive/triggers';
...
export const componentCategories: Array<{
  ...
  {
    title: 'Триггеры',
    components: [commandTrigger, textTrigger, anyMessageTrigger, groupMessageTrigger, callbackTrigger]
  },
  {
    title: 'Сообщения',
