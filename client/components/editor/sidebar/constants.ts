...
import { commandTrigger, textTrigger, anyMessageTrigger, groupMessageTrigger, callbackTrigger, incomingCallbackTrigger } from './massive/triggers';
...
export const componentCategories: Array<{
  ...
  {
    title: 'Триггеры',
    components: [commandTrigger, textTrigger, anyMessageTrigger, groupMessageTrigger, callbackTrigger, incomingCallbackTrigger]
  },
  {
    title: 'Сообщения',
