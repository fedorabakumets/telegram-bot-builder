...
import { sendInvoiceNode, createInvoiceLinkNode, refundStarsNode, editStarSubscriptionNode } from './massive/payments';
...
export const componentCategories: Array<{
  ...
  {
    title: 'Платежи',
    components: [sendInvoiceNode, createInvoiceLinkNode, refundStarsNode, editStarSubscriptionNode, successfulPaymentTrigger]
  },
  {
    title: 'Интеграции',
