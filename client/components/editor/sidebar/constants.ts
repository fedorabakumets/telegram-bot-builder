...
import { commandTrigger, textTrigger, anyMessageTrigger, groupMessageTrigger } from './massive/triggers';
...
export const componentCategories: Array<{
  ...
  {
    title: 'Триггеры',
    components: [commandTrigger, textTrigger, anyMessageTrigger, groupMessageTrigger]
  },
  {
    title: 'Сообщения',
