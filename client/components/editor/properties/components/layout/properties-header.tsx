            ...
            <div className="flex items-center gap-3 sm:gap-3.5 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <code className="text-xs sm:text-sm font-mono font-semibold text-blue-700 dark:text-blue-300 truncate group-hover:text-blue-800 dark:group-hover:text-blue-200 transition-colors block max-w-[14ch] sm:max-w-[20ch] md:max-w-[24ch] lg:max-w-[28ch] overflow-hidden text-truncate">
                      {displayNodeId}
                    </code>
