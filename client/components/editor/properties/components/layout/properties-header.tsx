            ...
            <div className="flex items-center gap-3 sm:gap-3.5 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <code className="text-xs sm:text-sm font-mono font-semibold text-blue-700 dark:text-blue-300 truncate group-hover:text-blue-800 dark:group-hover:text-blue-200 transition-colors block max-w-[70px] sm:max-w-[110px] md:max-w-[160px] lg:max-w-[180px]">
                      {displayNodeId}
                    </code>
