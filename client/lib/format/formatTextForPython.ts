/**
 * @fileoverview Утилита для форматирования текста для использования в Python коде
 * 
 * Этот модуль предоставляет функции для безопасного форматирования
 * текста перед встраиванием в Python код, с автоматическим выбором
 * подходящего формата в зависимости от содержимого.
 * 
 * @module formatTextForPython
 */
