 ...
 */
function generatePythonCodeLegacy(botData: BotData, botName: string = "MyBot", groups: BotGroup[] = [], userDatabaseEnabled: boolean = false, projectId: number | null = null, enableLogging: boolean = false): string {
  // Set global logging flag for this generation run
  globalLoggingEnabled = enableLogging;
