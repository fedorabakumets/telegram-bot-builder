 ...
 * 
 * Предоставляет функции для извлечения координат из ссылок различных
 * картографических сервисов и работы с геолокационными данными.
 * 
 * @module MapUtils
 * @version 1.0.0
 */
...
/**
 * Интерфейс для представления географических координат
 * 
 * Содержит широту и долготу в десятичных градусах.
 * Используется для унифицированного представления координат
 * из различных картографических сервисов.
 * 
 * @interface
 * @example
 * ```typescript
