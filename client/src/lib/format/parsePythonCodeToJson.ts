/**
 * @fileoverview Утилита для парсинга Python кода бота в JSON структуру
 * 
 * Этот модуль предоставляет функции для анализа сгенерированного
 * Python кода бота и восстановления из него структуры узлов и
 * соединений, которую можно использовать для визуализации в редакторе.
 * 
 * @module parsePythonCodeToJson
 */
