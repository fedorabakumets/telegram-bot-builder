/**
 * @fileoverview Утилита для генерации уникальных коротких идентификаторов
 * 
 * Этот модуль предоставляет функции для создания уникальных коротких
 * идентификаторов для узлов графа на основе их полных идентификаторов.
 * 
 * @module generateUniqueShortId
 */
