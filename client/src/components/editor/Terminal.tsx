...
export const Terminal = forwardRef<TerminalHandle, TerminalProps>(({
  ...
  return (
    <div className={`border rounded-lg overflow-hidden bg-black text-green-400 font-mono text-sm transition-all duration-200 w-full ${isVisible ? 'max-h-[320px] opacity-100' : 'hidden'}`}>
      {/* Заголовок терминала */}
