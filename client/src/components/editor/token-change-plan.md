...
- [x] 7. При отображении токена показывается полный токен, а не маскированный (обновлено: теперь при отображении показывается полный токен, а не маскированный)
...
- [x] При двойном клике на токен в карточке бота:
  ...
  - Показывается полный токен для редактирования
