...
export function InlineRichEditor({
  ...
  return (
    <div className="space-y-2 sm:space-y-3">
      {/* Modern Toolbar */}
      <div className="bg-gradient-to-r from-slate-50/60 to-slate-100/40 dark:from-slate-950/40 dark:to-slate-900/40 border border-slate-200/50 dark:border-slate-800/50 rounded-lg p-2.5 sm:p-3 backdrop-blur-sm overflow-x-auto">
        <div className="flex flex-row flex-wrap items-center gap-2 min-w-fit">
          {/* Formatting Tools */}
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                ...
                >
                  ...
                  <span className="sm:hidden">Пер</span>
                </Button>
              </DropdownMenuTrigger>
