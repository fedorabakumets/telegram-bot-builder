...
export function Canvas({ 
  ...
  return (
    <main className="w-full h-full relative overflow-hidden bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 dark:from-slate-950 dark:via-gray-950 dark:to-slate-900">
      ...
      {/* Canvas Toolbar - фиксированная панель вверху */}
      <div className="absolute top-6 z-40 pointer-events-none" style={{
        left: sidebarVisible ? '280px' : '20px',
        right: propertiesVisible ? '320px' : '20px'
      }}>
        <div className="flex items-center space-x-3 pointer-events-auto canvas-controls">
          {/* Кнопки панели инструментов теперь в фиксированной панели вверху */}
        </div>
      </div>
