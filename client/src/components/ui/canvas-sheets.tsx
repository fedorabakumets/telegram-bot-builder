...
export function CanvasSheets({
  ...
  return (
    <div className={`flex items-center justify-center gap-2 bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm border border-gray-200 dark:border-slate-700 rounded-lg shadow-lg relative transition-all duration-300 hover:shadow-xl ${isMobile ? 'px-3 py-3' : 'px-4 py-3'}`}>
