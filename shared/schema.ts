...
export const nodeSchema = z.object({
  ...
  data: z.object({
    ...
    broadcastTargetNode: z.string().optional(), // Целевой узел рассылки для привязки message узлов
    enableBroadcast: z.boolean().default(false).optional(), // Участие узла в рассылке
    enableConfirmation: z.boolean().default(false).optional(), // Требовать подтверждение перед рассылкой
    confirmationText: z.string().optional(), // Текст сообщения для подтверждения рассылки
