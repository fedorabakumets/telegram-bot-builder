...
export const assignmentSchema = z.object({
  ...
  /** Сохранить значение в PostgreSQL после присваивания (по умолчанию да — иначе переменные пропадают после рестарта) */
  persistToDb: z.boolean().optional().default(true),
});
