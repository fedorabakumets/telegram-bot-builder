...
| Дублирование кнопки | ✅ Готово |
| Drag-and-drop переупорядочивание кнопок | ❌ Отклонено |
| Действие copy_text (Bot API 7.11) | ✅ Готово |
| Визуальное различие типов кнопок | ❌ Отклонено |
| Циклические переходы | ❌ Отклонено |
| Действие web_app (Telegram Mini App) | ✅ Готово |
| `style` — цвет кнопки (Bot API 9.4) | ✅ Готово |
