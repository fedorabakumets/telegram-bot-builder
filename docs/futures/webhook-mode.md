...
- **Память:** ~0.5MB/бот вместо ~80MB. 100 ботов = 50MB вместо 8GB
...
- **Нет distributed lock:** нет постоянного процесса — нет проблемы двойного запуска
- **Нет restoreRunningBots:** нечего восстанавливать
